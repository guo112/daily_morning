...
def get_weather():
  ...
  return weather['weather'], math.floor(weather['temp']),weather['low'],math.floor(weather['low']),weather['high'],math.floor(weather['high']),weather['humidity'],math.floor(weather['humidity']),weather['wind'],weather['pm25'],math.floor(weather['pm25']),
