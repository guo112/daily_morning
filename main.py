...
data = {"weather":{"value":wea,"color":get_random_color()},"city":{"value":city,"color":get_random_color()},"temperature":{"value":temperature,"color":get_random_color()},"words":{"value":get_words(),"color":get_random_color()},"love_days":{"value":get_count(),"color":get_random_color()},"birthday_left":{"value":get_birthday(),"color":get_random_color()},"humidity": {"value":humidity,"color":get_random_color()},"wind": {"value":wind,"color":get_random_color()},"pm25": {"value":pm25,"color":get_random_color()},"min_temperature":{"value":low, "color":get_random_color()},"max_temperature":{"value":high, "color":get_random_color()}}
