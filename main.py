...
def get_weather():
  ...
  return weather['weather'], math.floor(weather['temp']),weather['low'],math.floor(weather['low']),weather['high'],math.floor(weather['high']),weather['humidity'],math.floor(weather['humidity']),weather['wind'],math.floor(weather['wind']),weather['pm25'],math.floor(weather['pm25']),
...
# weather, temperature,low,high,humidity,wind,pm25= get_weather()
